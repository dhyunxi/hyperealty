...
# 基础路径配置
PWD="/home/hyperealty"
ID_PATH="${PWD}/organizations"
CHANNEL_PATH="${PWD}/channel-artifacts"
...
ORDERER_CA="${ID_PATH}/ordererOrganizations/${DOMAIN}/orderers/orderer1.${DOMAIN}/msp/tlscacerts/tlsca.${DOMAIN}-cert.pem"
